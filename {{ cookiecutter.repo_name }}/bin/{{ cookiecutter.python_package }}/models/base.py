...
from algolite import ModelInterface, Algo, DataFilter, ModelParams
...
class BaseModel(ModelInterface):
    def __init__(self, strategy: Optional[Algo] = None, data_filter: Optional[DataFilter] = None) -> None:
