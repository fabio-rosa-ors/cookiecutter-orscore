...
from algolite import Pipeline, Algo, Command, FSPath, ModelFactory
...
class BasePipeline(Pipeline):
    ...
    def SelectFeatures(self, strategy: Algo, select_features: bool = True, features_json: bool = False, session: Optional[Command] = None) -> Dict[str, List[str]]:
        return {}